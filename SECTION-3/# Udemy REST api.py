...
from flask import Flask #importing Flask class from falsk

app = Flask(__name__)  # creating a uniqued named app object

@app.route('/')      # sepcifing our home page route
def home():
    return 'hello world'

app.run(port = 5000)    # specifing the part of computer where request comes
